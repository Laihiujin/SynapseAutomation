...
from ..models.APIResponseModel import ResponseModel, ErrorResponseModel  # 导入响应模型
...
async def fetch_one_video(request: Request,
                          aweme_id: str = Query(examples={"example": {"value": "7372484719365098803"}}, description="作品id/Video id")):
    """
    # [中文]
    ### 用途:
    - 获取单个作品数据
...
async def fetch_user_post_videos(request: Request,
                                 sec_user_id: str = Query(
                                     examples={"example": {"value": "MS4wLjABAAAANXSltcLCzDGmdNFI2Q_QixVTr67NiYzjKOIP5s03CAE"}},
...
async def fetch_user_like_videos(request: Request,
                                 sec_user_id: str = Query(
                                     examples={"example": {"value": "MS4wLjABAAAAW9FWcqS7RdQAWPd2AA5fL_ilmqsIFUCQ_Iym6Yh9_cUa6ZRqVLjVQSUjlHrfXY1Y"}},
                                     description="用户sec_user_id/User sec_user_id"),
                                 max_cursor: int = Query(default=0, description="最大游标/Maximum cursor"),
...
async def fetch_user_collection_videos(request: Request,
                                       cookie: str = Query(examples={"example": {"value": "YOUR_COOKIE"}},
...
async def fetch_user_mix_videos(request: Request,
                                mix_id: str = Query(examples={"example": {"value": "7348687990509553679"}}, description="合辑id/Mix id"),
                                max_cursor: int = Query(default=0, description="最大游标/Maximum cursor"),
                                counts: int = Query(default=20, description="每页数量/Number per page")):
    """
    # [中文]
...
async def fetch_user_live_videos(request: Request,
                                 webcast_id: str = Query(examples={"example": {"value": "285520721194"}},
...
async def fetch_user_live_videos_by_room_id(request: Request,
                                            room_id: str = Query(examples={"example": {"value": "7318296342189919011"}},
...
async def fetch_live_gift_ranking(request: Request,
                                  room_id: str = Query(examples={"example": {"value": "7356585666190461731"}},
                                                       description="直播间room_id/Room room_id"),
...
async def fetch_live_room_product_result(request: Request,
                                         cookie: str = Query(examples={"example": {"value": "YOUR_COOKIE"}},
                                                             description="用户网页版抖音Cookie/Your web version of Douyin Cookie"),
                                         room_id: str = Query(examples={"example": {"value": "7356742011975715619"}},
                                                              description="直播间room_id/Room room_id"),
                                         author_id: str = Query(examples={"example": {"value": "2207432981615527"}},
...
async def fetch_video_comments_reply(request: Request,
                                     item_id: str = Query(examples={"example": {"value": "7354666303006723354"}}, description="作品id/Video id"),
                                     comment_id: str = Query(examples={"example": {"value": "7354669356632638218"}},
...
async def get_sec_user_id(request: Request,
                          url: str = Query(
                              examples={"example": {"value": "https://www.douyin.com/user/MS4wLjABAAAANXSltcLCzDGmdNFI2Q_QixVTr67NiYzjKOIP5s03CAE"}})):
    """
    # [中文]
    ### 用途:
    - 提取单个用户id
...
async def get_aweme_id(request: Request,
                       url: str = Query(examples={"example": {"value": "https://www.douyin.com/video/7298145681699622182"}})):
    """
    # [中文]
    ### 用途:
    - 提取单个作品id
...
async def get_webcast_id(request: Request,
                         url: str = Query(examples={"example": {"value": "https://live.douyin.com/775841227732"}})):
    """
    # [中文]
    ### 用途:
    - 提取列表直播间号
