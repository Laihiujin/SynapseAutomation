...
_ROOT_ENV = PROJECT_ROOT.parent.parent / ".env"
if _ROOT_ENV.exists():
...
class Config:
    ...
    def _load_initial_config(self):
        ...
        env_chrome = os.getenv("LOCAL_CHROME_PATH")
        if env_chrome and not browser_config.get("chrome_instance_path"):
            env_path = Path(env_chrome)
            if not env_path.is_absolute():
                env_path = PROJECT_ROOT.parent.parent / env_path
            browser_config["chrome_instance_path"] = str(env_path)
